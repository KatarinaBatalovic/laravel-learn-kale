...
Route::get('/forgotpass', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('forgot');
Route::post('/forgotpassp', 'Auth\ForgotPasswordController@sendResetLinkEmail')->name('password.email');
Route::get('/resetpass', 'Auth\ResetPasswordController@showResetForm')->name('password.reset');
Route::post('/updatepass', 'Auth\ResetPasswordController@reset')->name('password.update');
...
Route::get('/kursevi-prodramiranja/{page}/{slug}', 'Frontend\FrontendController@page')->name('pages.show');
