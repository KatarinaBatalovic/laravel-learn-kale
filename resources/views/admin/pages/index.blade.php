                    ...
                    @if(count($rows) > 0)
                        @foreach($rows as $value)
                            <tr>
                                ...
                                <td>{{ $value->title }}
                                  <a data-placement="top" title='Sub pages' href='{{ route("pages.index", ["page" => $value->id]) }}' class="btn btn-sm btn-warning tooltip-custom">{{ __('Submenu').'('.count($value->pages).')' }}</a>
                                </td>
                                ...
                                <td class="text-center text-white"> 
                                    ...
                                    <a data-placement="top" title='Preview page' href="{{route('pages.show', ['page'=>$value->id, 'slug'=> Str::slug($value->title, '-') ]) }}" class="btn btn-sm btn-success tooltip-custom"><i class="fas fa-lock fa-sm fa-fw"></i></a>
